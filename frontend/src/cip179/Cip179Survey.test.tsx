...
it.each(questions)(
  ...
  async (question) => {
    ...
    const numeric =
      question.type === 'numericRange' || question.type === 'rating';
    const input = screen.getByRole(numeric ? 'textbox' : 'checkbox', {
      name: 'Extra',
    });
