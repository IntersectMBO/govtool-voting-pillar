...
import React__default, { useState, useEffect, useCallback, useMemo, createContext, useContext, useId as useId$1, forwardRef, useRef, useImperativeHandle } from 'react';
import { useNavigate, useLocation, useParams, NavLink, generatePath, BrowserRouter, Routes, Route } from 'react-router-dom';
import { useQuery, useInfiniteQuery, QueryClientProvider, QueryClient } from 'react-query';
import axios from 'axios';
import { format } from 'date-fns';
import { appendErrors, useWatch, useForm, useFormContext, get, Controller, FormProvider } from 'react-hook-form';
import { Button as Button$1, CircularProgress, Checkbox as Checkbox$3, Typography as Typography$2, InputBase, Box, styled as styled$2, Tab as Tab$1, TextareaAutosize, FormLabel, FormControlLabel, FormControl, RadioGroup, Radio as Radio$1, Link, Tabs, ButtonBase, Popover, Divider as Divider$1 } from '@mui/material';
...
function useTheme$2() {
  const theme = React$1.useContext(ThemeContext);
  if (process.env.NODE_ENV !== 'production') {
...
const formatDisplayDate = (date, outputFormat = 'do MMM yyyy') => format(new Date(date), outputFormat).toString();
...
const useGetProposalQuery = (proposalId, enabled) => {
  ...
  const {
    ...
    refetch,
    isRefetching
  } = useQuery([QUERY_KEYS.useGetProposalKey, dRepID, proposalId], () => getProposal(apiUrl, validationApiUrl, proposalId, dRepID), {
    staleTime: Infinity,
    enabled
  });
  return {
...
const useGetProposalsInfiniteQuery = ({
  ...
  const {
    ...
    isFetching,
    isFetchingNextPage
  } = useInfiniteQuery([QUERY_KEYS.useGetProposalsInfiniteKey, apiUrl, dRepID, filters, isEnabled, pendingTransaction?.vote?.transactionHash, searchPhrase, sorting], fetchProposals, {
...
const useGetProposalsQuery = ({
  ...
  const {
    data,
    isLoading
  } = useQuery([QUERY_KEYS.useGetProposalsKey, filters, searchPhrase, sorting, dRepID, pendingTransaction?.vote?.transactionHash], fetchProposals);
...
const useGetVoteContextTextFromFile = (url, enabled = true) => {
  const {
    data,
    isLoading
  } = useQuery([QUERY_KEYS.useGetVoteContextFromFile, url], () => getVoteContextTextFromFile(url), {
    enabled
  });
  return {
...
const useVoteActionForm = ({
  ...
  const confirmVote = useCallback(async values => {
    if (!canVote) return;
    setIsLoading(true);
...
const DataActionsBarContext = createContext(undefined);
...
const Divider = /*#__PURE__*/React$1.forwardRef(function Divider(inProps, ref) {
...
const Button = ({
  ...
  return jsxRuntimeExports.jsxs(Button$1, {
    sx: {
    ...
    children: [isLoading && jsxRuntimeExports.jsx(CircularProgress, {
      size: 26,
      sx: {
        position: 'absolute'
      }
...
const Checkbox$2 = ({
  ...
  const id = useId$1();
  return jsxRuntimeExports.jsx(Checkbox$3, {
    id: id,
    inputProps: {
...
const ExternalModalButton = ({
  ...
  return jsxRuntimeExports.jsxs(Button, {
    ...
    children: [jsxRuntimeExports.jsx(Typography$2, {
      variant: "body1",
      fontWeight: 500,
      color: "primary",
      children: label
...
const FormErrorMessage = ({
  ...
  return jsxRuntimeExports.jsx(Typography$2, {
    color: "red",
 ...
 */
const Tab = styled$2(props => jsxRuntimeExports.jsx(Tab$1, {
  disableRipple: true,
  ...props
}))(() => ({
  textTransform: 'none',
...
const TextAreaBase = styled$2(TextareaAutosize)(() => `
  font-family: "Poppins";
  font-weight: 400;
    ::placeholder {
      font-family: "Poppins";
...
const Tooltip$1 = /*#__PURE__*/React$1.forwardRef(function Tooltip(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntimeExports.jsxs(React$1.Fragment, {
    children: [/*#__PURE__*/React$1.cloneElement(children, childrenProps), /*#__PURE__*/jsxRuntimeExports.jsx(PopperComponent, _extends$1({
...
const DataActionsFilters = ({
  ...
  return jsxRuntimeExports.jsxs(Box, {
    ...
    ref: wrapperRef,
    children: [title && jsxRuntimeExports.jsx(FormLabel, {
      sx: {
        fontSize: 14,
        fontWeight: 500,
        color: '#9792B5',
      ...
      children: title
    }), options.map(item => jsxRuntimeExports.jsx(Box, {
      paddingX: "20px",
      sx: [{
        '&:hover': {
          bgcolor: '#E6EBF7'
      ...
      children: jsxRuntimeExports.jsx(FormControlLabel, {
        control: jsxRuntimeExports.jsx(Checkbox$3, {
          inputProps: {
        ...
        label: jsxRuntimeExports.jsx(Typography$2, {
          fontSize: 14,
          fontWeight: 500,
          children: item.label
        })
...
const DataActionsSorting = ({
  ...
  return jsxRuntimeExports.jsx(Box, {
    ...
    ref: wrapperRef,
    children: jsxRuntimeExports.jsxs(FormControl, {
      children: [jsxRuntimeExports.jsxs(Box, {
        ...
        children: options.map(item => jsxRuntimeExports.jsx(FormControlLabel, {
          sx: [{
            margin: 0,
            px: '20px',
...
const OrderActionsChip = props => {
  ...
  return jsxRuntimeExports.jsxs(Box, {
    ...
    children: [isFiltering && jsxRuntimeExports.jsxs(Box, {
      sx: {
        position: 'relative',
        display: 'flex',
        alignItems: 'center',
      ...
      children: [jsxRuntimeExports.jsx("img", {
        ...
        children: "Filter"
      }), !filtersOpen && chosenFiltersLength > 0 && jsxRuntimeExports.jsx(Box, {
        sx: {
          alignItems: 'center',
...
const DataActionsBar = ({
  ...
  return jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {
    children: jsxRuntimeExports.jsxs(Box, {
      ...
      display: "flex",
      justifyContent: "space-between",
      children: [jsxRuntimeExports.jsx(InputBase, {
        inputProps: {
        ...
        placeholder: "Search...",
        value: searchText,
        startAdornment: jsxRuntimeExports.jsx(Search, {
          style: {
            color: '#99ADDE',
            height: 16,
            marginRight: 4,
...
const DataMissingInfoBox = ({
  ...
  return isDataMissing && !isSubmitted && !isInProgress ? jsxRuntimeExports.jsxs(Box, {
    sx: {
      mb: 4,
      pr: 6,
      ...sx
...
const GovernanceActionCardElement = ({
  ...
  return jsxRuntimeExports.jsxs(Box, {
    ...
    children: [jsxRuntimeExports.jsxs(Box, {
      ...
      display: "flex",
      children: textVariant === 'pill' ? jsxRuntimeExports.jsx(Box, {
        sx: {
          padding: '6px 18px',
          overflow: 'hidden',
          bgcolor: 'lightBlue',
        ...
        children: [isMarkdown ? jsxRuntimeExports.jsx(Markdown, {
          ...
          children: text
        }), isCopyButton && jsxRuntimeExports.jsx(Box, {
          ml: 1,
...
const StyledTab = styled$2(props => jsxRuntimeExports.jsx(Tab$1, {
  disableRipple: true,
  ...props
}))(({
  isMobile
...
const GovernanceActionDetailsCardData = ({
  ...
  const nonNullProtocolParams = useMemo(() => filterOutNullParams(protocolParams, ['id', 'registered_tx_id', 'key']), [protocolParams]);
...
const HardforkDetailsTabContent = ({
  ...
  return jsxRuntimeExports.jsxs(Box, {
    ...
    children: [jsxRuntimeExports.jsxs(Box, {
      ...
      }), prevGovActionId ? jsxRuntimeExports.jsxs(Box, {
        sx: {
          display: 'flex',
          gap: 1
        },
...
const GovernanceActionDetailsDiffView = ({
  ...
  const diffText = formatLines(diffLines(JSON.stringify(oldJson, null, 2), JSON.stringify(newJson, null, 2)));
  ...
  return jsxRuntimeExports.jsxs(Box, {
    children: [jsxRuntimeExports.jsxs(Box, {
      ...
      children: [jsxRuntimeExports.jsx(Typography$2, {
        ...
        children: "Existing"
      }), jsxRuntimeExports.jsx(Typography$2, {
        sx: {
          fontSize: '14px',
          color: 'neutralGray',
          lineHeight: '20px',
...
const SliderArrows = ({
  ...
  instanceRef,
  itemsPerView
}) => instanceRef.current && jsxRuntimeExports.jsxs(Box, {
  sx: {
    display: 'flex',
    gap: '4px'
  },
 ...
 * ```
 */
const ExternalLinkModal = forwardRef((_, ref) => {
  const {
    state,
    closeModal
  } = useModal();
...
const LoadingModal = forwardRef((_, ref) => {
  ...
  return jsxRuntimeExports.jsxs(ModalWrapper, {
    ...
    children: [jsxRuntimeExports.jsx(Loader, {
      ...
      children: jsxRuntimeExports.jsxs(Typography$2, {
        textAlign: "center",
        sx: {
          fontSize: '16px',
          fontWeight: '400'
 ...
 * ```
 */
const StatusModal = forwardRef((_, ref) => {
  const {
    state,
    closeModal
  } = useModal();
  ...
  return jsxRuntimeExports.jsxs(ModalWrapper, {
    ...
    children: [jsxRuntimeExports.jsx("img", {
      ...
      children: jsxRuntimeExports.jsxs(Typography$2, {
        ...
        children: [state?.message, ' ', state?.link && jsxRuntimeExports.jsx(Link, {
    ...
    }), state?.cancelText && jsxRuntimeExports.jsx(Button$1, {
      "data-testid": "cancel-modal-button",
    ...
    }), state?.feedbackText && jsxRuntimeExports.jsx(Button$1, {
 ...
 */
const SubmittedVotesModal = forwardRef((_, ref) => {
  const {
    state
  } = useModal();
...
const VoteActionForm = ({
  ...
  const [showWholeVoteContext, setShowWholeVoteContext] = useState(false);
  const {
    voter
  } = usePillarContext();
  const {
  ...
  const renderCancelButton = useMemo(() => jsxRuntimeExports.jsx(Button, {
  ...
  const renderChangeVoteButton = useMemo(() => jsxRuntimeExports.jsx(Button, {
  ...
  return jsxRuntimeExports.jsxs(Box, {
    ...
    children: [jsxRuntimeExports.jsxs(Box, {
      ...
      }), voteContextText && jsxRuntimeExports.jsxs(Box, {
        sx: {
          display: 'flex',
          flexDirection: 'column',
          mt: 2
    ...
    }), previousVote?.vote && previousVote?.vote !== vote ? jsxRuntimeExports.jsxs(Box, {
      display: "flex",
      flexDirection: isMobile ? 'column' : 'row',
      justifyContent: "space-between",
      children: [isMobile ? renderChangeVoteButton : renderCancelButton, jsxRuntimeExports.jsx(Box, {
        px: 1,
        py: isMobile ? 1.5 : 0
...
const VoteContextModal = () => {
  ...
  return jsxRuntimeExports.jsx(ModalWrapper, {
    ...
    children: jsxRuntimeExports.jsxs(FormProvider, {
      ...methods,
...
const PillarContext = createContext(undefined);
...
const GovernanceActionsToVote = ({
  ...
  const navigate = useNavigate();
  const onGovernanceActionCardClick = useCallback(action => () => {
    navigate(generatePath(PATHS.governanceActionsAction, {
  ...
  const onGovernanceActionSliderShowAllClick = useCallback(title => () => {
  ...
  return jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {
    children: !proposals.length ? jsxRuntimeExports.jsx(Typography, {
      ...
      children: proposals?.map((item, index) => jsxRuntimeExports.jsxs(Box, {
        pb: 2.5,
        ...
        }), index < proposals.length - 1 && jsxRuntimeExports.jsx(Box, {
  ...
  return areDRepVotesLoading ? jsxRuntimeExports.jsx(Box, {
    ...
    children: !data.length ? jsxRuntimeExports.jsx(Typography$2, {
      ...
      children: filteredData?.map(item => jsxRuntimeExports.jsxs("div", {
        ...
        }, item.title), jsxRuntimeExports.jsx(Box, {
...
const GovernanceActionsPage = () => {
  ...
  const [content, setContent] = useState(state && state.isVotedListOnLoad ? 1 : 0);
  const handleChange = (_event, newValue) => {
    setContent(newValue);
  };
  useEffect(() => {
  ...
  return jsxRuntimeExports.jsxs(Box, {
    ...
    children: [jsxRuntimeExports.jsx(Typography, {
    ...
    }), isMobile && jsxRuntimeExports.jsx(Divider$1, {
      style: {
        borderColor: '#FFFFFF',
        borderWidth: 1,
        marginBottom: 30
      ...
      }), !proposals || isProposalsLoading ? jsxRuntimeExports.jsx(Box, {
        sx: {
          alignItems: 'center',
          display: 'flex',
          flex: 1,
...
const GovernanceActionDetails = () => {
  ...
  return jsxRuntimeExports.jsx(Box, {
    ...
    children: jsxRuntimeExports.jsxs(Box, {
      ...
      flexDirection: "column",
      width: "100%",
      children: [isMobile ? jsxRuntimeExports.jsx(Box, {
        sx: {
          display: 'flex',
          alignItems: 'center',
          padding: '8px 0 24px',
        ...
        onClick: () => navigate(state && state.openedFromCategoryPage ? generatePath(PATHS.governanceActionsCategory, {
      ...
      }), isLoading ? jsxRuntimeExports.jsx(Box, {
        alignItems: "center",
        display: "flex",
        flex: 1,
        justifyContent: "center",
        children: jsxRuntimeExports.jsx(CircularProgress, {})
      }) : proposal ? jsxRuntimeExports.jsx(Box, {
...
const GovernanceActionsCategory = () => {
  ...
  const mappedData = useMemo(() => removeDuplicatedProposals(proposals), [proposals]);
  // useEffect(() => {
    ...
    children: jsxRuntimeExports.jsx(Box, {
      ...
      children: jsxRuntimeExports.jsxs(Box, {
        ...
        children: [jsxRuntimeExports.jsxs(Link, {
          ...
          children: [mappedData.map(item => jsxRuntimeExports.jsx(Box, {
            pb: 4.25,
            children: jsxRuntimeExports.jsx(GovernanceActionCard, {
              ...item,
              onClick: () => {
          ...
          }, item.txHash + item.index)), proposalsHaveNextPage && isProposalsFetchingNextPage && jsxRuntimeExports.jsx(Box, {
            py: 4,
            display: "flex",
            justifyContent: "center",
            ref: loadNextPageRef,
...
export { GovernanceActionDetails, GovernanceActionsCategory, GovernanceActionsPage, VotingPillar as default };
