...
var App = function () { return (jsxRuntimeExports.jsx(Box, __assign({ sx: { display: 'flex', flex: 1, minHeight: '100vh' } }, { children: jsxRuntimeExports.jsx(Button, { children: "Test mui button" }) }))); };
