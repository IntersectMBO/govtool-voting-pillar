...
var StyleSheet = /*#__PURE__*/ (function () {
  ...
  function StyleSheet(options) {
    ...
    this.isSpeedy =
      options.speedy === undefined ? !isDevelopment$2 : options.speedy;
    this.tags = [];
    this.ctr = 0;
...
var useInsertionEffect = React$1['useInsertion' + 'Effect']
  ...
  : false;
var useInsertionEffectAlwaysWithSyncFallback = !isBrowser$2
  ? syncFallback
...
function StyledEngineProvider(props) {
  ...
  return injectFirst && cache
    ? /*#__PURE__*/ jsxRuntimeExports.jsx(CacheProvider, {
        value: cache,
        children: children,
      })
    : children;
...
function GlobalStyles(props) {
  ...
  const globalStyles =
    typeof styles === 'function'
      ? (themeInput) =>
          styles(isEmpty$1(themeInput) ? defaultTheme : themeInput)
      : styles;
    ...
    const styleFromPropValue = (propValueFinal) => {
      ...
      if (propValueFinal === value && typeof propValueFinal === 'string') {
        ...
        value = getStyleValue(
          themeMapping,
          transform,
          `${prop}${propValueFinal === 'default' ? '' : capitalize$1(propValueFinal)}`,
          propValueFinal
        );
      }
...
function createTheme$2(options = {}, ...args) {
  ...
  muiTheme = args.reduce(
    (acc, argument) => deepmerge$1(acc, argument),
    muiTheme
  );
  muiTheme.unstable_sxConfig = _extends$1(
    {},
    defaultSxConfig,
...
function createPalette(palette) {
  ...
  function getContrastText(background) {
    const contrastText =
      getContrastRatio_1(background, dark.text.primary) >= contrastThreshold
        ? dark.text.primary
        : light.text.primary;
    if (process.env.NODE_ENV !== 'production') {
...
The color object needs to have a \`main\` property or a \`${mainShade}\` property.`
          : formatMuiErrorMessage$1(11, name ? ` (${name})` : '', mainShade)
      );
    }
  ...
  ({ theme, ownerState }) => {
    ...
    return _extends$1(
      ...
      theme.typography.button,
      {
        ...
        [`&.${buttonClasses.focusVisible}`]: _extends$1(
          {},
          ownerState.variant === 'contained' && {
...
var App = function () {
  return jsxRuntimeExports.jsx(
    Box,
    __assign(
      { sx: { display: 'flex', flex: 1, minHeight: '100vh' } },
      {
        children: jsxRuntimeExports.jsx(Button, {
          children: 'Test mui button',
        }),
      }
    )
  );
